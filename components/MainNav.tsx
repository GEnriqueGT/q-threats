...
const inactiveClass = 'text-white/75 hover:bg-white/10 hover:text-white border border-transparent';
const activeClass = 'bg-teal-500/25 text-white border border-teal-400/35';
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:gap-8">
          ...
          <div className="flex flex-wrap gap-1">
            {ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={[linkClass, active ? activeClass : inactiveClass].join(' ')}
                >
                  {item.label}
                </Link>
              );
            ...
            <a
              ...
              className={[linkClass, inactiveClass].join(' ')}
            >
              Docs
            </a>
          </div>
